...
function displayLibrary() {
  ...
  myLibrary.forEach((book, index) => {
    ...
    read.classList =
      "table-cell border-solid border-2 border-black p-1 text-center";
    ...
    toggleRead.classList =
      "rounded-full bg-slate-500 border-solid border-2 border-black p-1";
    toggleReadCell.appendChild(toggleRead);
    toggleReadCell.classList =
      "table-cell border-solid border-2 border-black p-1 text-center";
